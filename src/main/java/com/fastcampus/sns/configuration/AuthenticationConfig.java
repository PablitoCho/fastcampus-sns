...
//                .antMatchers("/api/*/users/join", "/api/*/users/login").permitAll()
                ...
                .and()
                .addFilterBefore(new JwtTokenFilter(key, userService), UsernamePasswordAuthenticationFilter.class) // 요청마다 들어온 토큰이 어떤 유저인지 특정하는 필터를 추가
                .exceptionHandling() // 인증시 문제가 생긴 경우 처리
